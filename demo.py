...
def _get_args():
    parser = ArgumentParser(description="Synth-Empathy online chat demo.")
    parser.add_argument(
        "-c",
        "--checkpoint-path",
        type=str,
...
def _launch_demo(args, model, tokenizer):
    ...
    with gr.Blocks() as demo:
        #gr.Markdown("""<center><font size=4>Synthetic-Empathy-7B-Instruct""")
        chatbot = gr.Chatbot(label="Empathy", elem_classes="control-height")
